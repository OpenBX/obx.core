...
$arModuleClasses = array(
	...
	,'OBX\Core\Assistants_Alpha\BasicAssistant'		=> 'classes/Assistants/BasicAssistant.php'
	,'OBX\Core\Assistants_Alpha\IBlockAssistant'		=> 'classes/Assistants/IBlockAssistant.php'
);
if($DBType === 'mysql') {
