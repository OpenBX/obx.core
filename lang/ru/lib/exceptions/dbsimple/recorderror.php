...
$MESS[_::ID._::E_CANT_READ_FROM_DB_RESULT] = 'Не удалось прочитать Запись(Record) из результата выборки из базы данных';
$MESS[_::ID._::E_WRONG_DB_RESULT_ENTITY] = 'Результат выборки из базы данных не соответствует сущности Записи(Record)';
$MESS[_::ID._::E_CANT_SET_PRIMARY_KEY_VALUE] = 'Нелья зменять значение поля первичного ключа Записи';
$MESS[_::ID._::E_CANT_FIND_RECORD] = 'Не удалось найти запись';
...
$MESS[_::ID._::E_CANT_RD_BY_UQ_NOT_ALL_FLD] = 'Невозможно прочитать запись по значениям полей уникального ключа. Не все поля заполнены';
